...
var Contact = function(config, single, plural){
  ...
  return {
    ...
    create: function(firstname, lastname, email, current_user){
      ...
      winston.debug("rollout-node-sdk contact.create", create);
     ...
     return new Promise(function(resolve, reject){
       request.post('/' + plural+ admintoken, create).then(function(data){
         winston.debug("rollout-node-sdk contact.created", data);
         resolve(data);
       }).catch(function(err){
         reject(err);
       });
   ...
   update: function(firstname, lastname, current_user){
    ...
    winston.debug("rollout-node-sdk contact.update", update);
    ...
    return new Promise(function(resolve, reject){
      request.put('/' + plural+'/me'+ admintoken, update).then(function(data){
        winston.debug("rollout-node-sdk contact.updated", data);
        resolve(data);
      }).catch(function(err){
        reject(err);
      });
