  ...
  return {
    ...
    archive: function(recipient_id, user_id){
      ...
      if (config.admintoken) {
       ...
       winston.debug("rollout-node-sdk admintoken", admintoken);
      }

      return new Promise(function(resolve, reject){       

        request.delete('/' + plural +'/'+recipient_id+ admintoken, body).then(function(data){
          winston.debug("rollout-node-sdk conversation.archived", data);
          resolve(data);
        }).catch(function(err){
          winston.debug("rollout-node-sdk conversation.archived", err);
          reject(err);
        });
      });
    },
    ...
    typing: function(recipient_id, writer_id, text, timestamp){
      ...
      return new Promise(function(resolve, reject){       
        ...
        request.put('/typings/'+recipient_id+ admintoken, body).then(function(data){
          winston.debug("rollout-node-sdk conversation typing", data);
          resolve(data);
        }).catch(function(err){
          winston.debug("error rollout-node-sdk conversation typing", err);
          reject(err);
        });
      });
    },
    ...
    stopTyping: function(recipient_id, writer_id){
      ...
      return new Promise(function(resolve, reject){       
        ...
        request.delete('/typings/'+recipient_id+ admintoken, body).then(function(data){
          winston.debug("rollout-node-sdk conversation stoptypings", data);
          resolve(data);
        }).catch(function(err){
          winston.debug("error rollout-node-sdk conversation stoptypings", err);
          reject(err);
        });
      });
    },
